package io.ipfstwitter.node.apkUpdater
...
import io.ipfstwitter.node.apkUpdater.DownloadService.DownloadBinder
import io.ipfstwitter.node.apkUpdater.UpdateHelper.clearDownloadFailedCount
import io.ipfstwitter.node.apkUpdater.UpdateHelper.downloadFailedCountPlus
import io.ipfstwitter.node.apkUpdater.UpdateHelper.getApkPathFromSp
import io.ipfstwitter.node.apkUpdater.UpdateHelper.getApkVersionCodeFromSp
import io.ipfstwitter.node.apkUpdater.UpdateHelper.getCurrentVersionCode
import io.ipfstwitter.node.apkUpdater.UpdateHelper.getCurrentVersionName
import io.ipfstwitter.node.apkUpdater.UpdateHelper.getDownloadFailedCount
import io.ipfstwitter.node.apkUpdater.UpdateHelper.getFileSignature
import io.ipfstwitter.node.apkUpdater.UpdateHelper.installApk
import io.ipfstwitter.node.apkUpdater.UpdateHelper.getUpdateType
import io.ipfstwitter.node.apkUpdater.UpdateHelper.putApkVersionCode2Sp
import io.ipfstwitter.node.apkUpdater.UpdateHelper.removeOldApk
import io.ipfstwitter.node.apkUpdater.callback.CompleteUpdateCallback
import io.ipfstwitter.node.apkUpdater.callback.DownloadProgressCallback
import io.ipfstwitter.node.apkUpdater.callback.IUpdateCallback
import io.ipfstwitter.node.apkUpdater.dialog.ApkUpdateDialog
import io.ipfstwitter.node.apkUpdater.dialog.DefaultUpdateDialog
import io.ipfstwitter.node.apkUpdater.util.NetWorkStateUtil
import io.ipfstwitter.node.apkUpdater.util.NetWorkStateUtil.ConnectivityChangeReceiver
