package io.ipfstwitter.node.apkUpdater.dialog
...
import io.ipfstwitter.node.R
import io.ipfstwitter.node.apkUpdater.ApkUpdater
import io.ipfstwitter.node.apkUpdater.UpdateType
...
open class DefaultUpdateDialog(protected val updater: ApkUpdater, @StyleRes private val style: Int = R.style.KelinApkUpdaterUpdateDialog) : DialogFragment(), ApkUpdateDialog {
    ...
    protected open fun onInitView(versionName: CharSequence?, updateTitle: CharSequence?, updateContent: CharSequence?, isAutoCheck: Boolean) {
        ...
        tvKelinApkUpdaterSure.apply {
            ...
            text = getString(R.string.kelin_apk_updater_update)
            setOnClickListener {
                ...
                if (!isForce) {
                    ...
                    text = getString(R.string.kelin_apk_updater_downing)
                }
    ...
    protected open fun onShowNetworkStatusChanged(available: Boolean) {
        tvKelinApkUpdaterSure?.text = if (available) getString(R.string.kelin_apk_updater_downing) else getString(R.string.kelin_apk_updater_network)
    }
