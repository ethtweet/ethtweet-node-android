package io.ethtweet.node.apkUpdater
...
import io.ethtweet.node.apkUpdater.DownloadService.DownloadBinder
import io.ethtweet.node.apkUpdater.UpdateHelper.clearDownloadFailedCount
import io.ethtweet.node.apkUpdater.UpdateHelper.downloadFailedCountPlus
import io.ethtweet.node.apkUpdater.UpdateHelper.getApkPathFromSp
import io.ethtweet.node.apkUpdater.UpdateHelper.getApkVersionCodeFromSp
import io.ethtweet.node.apkUpdater.UpdateHelper.getCurrentVersionCode
import io.ethtweet.node.apkUpdater.UpdateHelper.getCurrentVersionName
import io.ethtweet.node.apkUpdater.UpdateHelper.getDownloadFailedCount
import io.ethtweet.node.apkUpdater.UpdateHelper.getFileSignature
import io.ethtweet.node.apkUpdater.UpdateHelper.installApk
import io.ethtweet.node.apkUpdater.UpdateHelper.getUpdateType
import io.ethtweet.node.apkUpdater.UpdateHelper.putApkVersionCode2Sp
import io.ethtweet.node.apkUpdater.UpdateHelper.removeOldApk
import io.ethtweet.node.apkUpdater.callback.CompleteUpdateCallback
import io.ethtweet.node.apkUpdater.callback.DownloadProgressCallback
import io.ethtweet.node.apkUpdater.callback.IUpdateCallback
import io.ethtweet.node.apkUpdater.dialog.ApkUpdateDialog
import io.ethtweet.node.apkUpdater.dialog.DefaultUpdateDialog
import io.ethtweet.node.apkUpdater.util.NetWorkStateUtil
import io.ethtweet.node.apkUpdater.util.NetWorkStateUtil.ConnectivityChangeReceiver
