package io.ethtweet.node.apkUpdater.callback
...
interface IUpdateCallback {
     ...
     * @param updateType       更新类型。这个字段的值其实就[UpdateInfo.updateType](io.ethtweet.node.apkUpdater.UpdateInfo.updateType)和
     * [UpdateInfo.forceUpdateVersionCodes](io.ethtweet.node.apkUpdater.UpdateInfo.forceUpdateVersionCodes)的返回值。
     */
