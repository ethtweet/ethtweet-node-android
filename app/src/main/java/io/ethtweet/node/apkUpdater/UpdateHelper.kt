...
object UpdateHelper {
     ...
     * apk 文件存储路径
     */
    private const val SP_KEY_DOWNLOAD_APK_PATH = "io.ethtweet.node.apkUpdater.sp_key_download_apk_path"

    /**
     * 上一次下载的APK的版本号。
     */
    private const val SP_KEY_DOWNLOAD_APK_VERSION_CODE = "io.ethtweet.node.apkUpdater.sp_key_download_apk_version_code"
